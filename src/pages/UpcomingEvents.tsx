...
export default function UpcomingEvents() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      {/* Upcoming Events Subheader */}
      <div className="w-full bg-white z-10">
        <section className="mb-2 px-4 pt-4">
          <div className="flex items-start justify-between w-full">
            {/* Subheader left side */}
            <div style={{width:'180px'}}>
              <div className="h-0.5 rounded w-full mb-0" style={{backgroundColor:'#c0e2e7', opacity: 0.75}}></div>
              <div className="flex items-center space-x-2 pl-1">
                <CalendarIcon />
                <h2 className="text-[#b91142] text-lg font-medium tracking-tight">Upcoming Events</h2>
              </div>
              <div className="h-0.5 rounded w-full mt-0" style={{backgroundColor:'#c0e2e7', opacity: 0.75}}></div>
            </div>
          ...
          <p className="mt-2 text-gray-700 text-[15px] leading-snug font-medium w-full text-left section-blurb" style={{marginBottom: 0, paddingBottom: 0}}>
            Kicaco keeps all of your child's upcoming events visible, so you never miss a thing.
          </p>
        </section>
      </div>
