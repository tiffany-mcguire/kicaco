    ...
    <div className="day-based-time-grid bg-white rounded-lg shadow-sm p-3 mb-8">
        ...
        <div className="flex-1 space-y-3 min-w-0">
          {[0, 1, 2, 3].map((dayIndex) => {
            ...
            return (
              <div 
                key={dayIndex} 
                className={`day-based-time-grid__day-card flex flex-col rounded-lg border-2 overflow-hidden ${!hasSelectedDates ? 'opacity-50' : ''}`}
                style={{ 
              ...
              >
                {!hasSelectedDates ? (
                  <>
                    {/* Faux Time Button/Display - Inactive */}
                    <div className="day-based-time-grid__time-display px-1 pt-3 pb-1">
                      <div className="px-1">
                        <button
                          disabled
                          className="day-based-time-grid__set-time-btn w-full text-[13px] bg-[#217e8f]/20 text-[#1a6e7e] py-1.5 rounded-lg transition-colors flex items-center justify-center gap-2 cursor-not-allowed opacity-50"
                        >
                    ...
                    <div className="day-based-time-grid__dates-section bg-white/10 px-4 py-2 opacity-50">
                      <button
                        disabled
                          ...
                          {showFullPickerFor === `day-${dayIndex}` ? (
                            <div className="day-based-time-grid__custom-picker space-y-3 w-full px-1 sm:px-2">
                                  ...
                                  {['00', '15', '30', '45'].map(m => (
                                    <button 
                                      ...
                                      className={`w-full h-6 sm:h-8 flex items-center justify-center text-xs md:text-[13px] rounded-md font-semibold border-2 ${
                                        customTime.minute === m
                                          ? 'bg-[#2f8fa4] text-white border-[#217e8f]'
                                          : 'bg-white/70 text-[#217e8f] hover:bg-white border-[#217e8f]/30'
                                      }`}
                              ...
                              <div className="py-6">
                                <button 
                                  ...
                                  className={`day-based-time-grid__set-time-btn w-full h-[30px] rounded-md text-[13px] font-medium flex items-center justify-center shadow-sm focus:outline-none transition-colors border-2 ${
                            ...
                            <div className="day-based-time-grid__scroll-picker">
                              ...
                              <div className="day-based-time-grid__time-content h-[240px] flex flex-col px-1">
                                ...
                                <div ref={scrollableTimeRef} className="day-based-time-grid__scrollable-options space-y-[8.5px] flex-1 overflow-y-auto hide-scrollbar pt-[8.5px]">
                                ...
                                <div className="day-based-time-grid__confirm-container h-8 flex items-center flex-shrink-0">
                                  <button
                                    ...
                                    className={`day-based-time-grid__confirm w-full h-[30px] rounded-md text-[13px] font-medium flex items-center justify-center shadow-sm focus:outline-none transition-colors border-2 ${
                        ...
                        <div className="day-based-time-grid__time-picker w-full">
                          {showFullPickerFor === `day-${dayIndex}` ? (
                            <div className="day-based-time-grid__custom-picker space-y-3 w-full px-1 sm:px-2">
                              ...
                              {/* Minutes */}
                              <div className="bg-white/50 rounded-lg p-1">
                                <div className="text-center text-xs font-semibold text-gray-600 mb-2">Select Minute</div>
                                <div className="grid grid-cols-4 gap-0.5 sm:gap-1">
                                  {['00', '15', '30', '45'].map(m => (
                                    <button 
                                      key={m}
                              ...
                              {/* AM/PM */}
                              <div className="bg-white/50 rounded-lg p-1">
                                <div className="text-center text-xs font-semibold text-gray-600 mb-2">AM or PM</div>
                                <div className="grid grid-cols-2 gap-0.5 sm:gap-1">
                                  {['AM', 'PM'].map(period => (
                                    <button
                                      key={period}
      ...
      <div className="day-based-time-grid__actions mt-4 flex justify-end">
        <button
          ...
          className="day-based-time-grid__continue-btn bg-[#2f8fa4] text-white rounded-md font-medium transition-colors enabled:hover:bg-[#217e8f] disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center border-2 border-[#217e8f] disabled:border-gray-300"
          style={{
            width: '115px',
            height: '30px',
            fontSize: '13px',
