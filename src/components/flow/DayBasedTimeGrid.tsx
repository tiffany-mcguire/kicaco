                            ...
                            <div className="day-based-time-grid__custom-picker space-y-3 w-full px-1 sm:px-2">
                              ...
                              <div className="py-6">
                                <button 
                                  ...
                                  className={`day-based-time-grid__set-time-btn w-full h-[30px] rounded-md text-[13px] font-medium flex items-center justify-center shadow-sm focus:outline-none transition-colors ${
